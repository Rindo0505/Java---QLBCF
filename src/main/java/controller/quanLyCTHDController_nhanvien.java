...
/**
 * Servlet implementation class quanLyCTHD_nhanvien
 */
@WebServlet("/quanLyCTHDController_nhanvien")
public class quanLyCTHDController_nhanvien extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public quanLyCTHDController_nhanvien() {
        super();
...
//				}
//
//				response.sendRedirect("quanLyCTHDController_nhanvien");
//			}
			...
			RequestDispatcher rd = request.getRequestDispatcher("QuanLyCTHD_nhanvien.jsp");
