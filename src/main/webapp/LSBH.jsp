	...
	<div class="app">
		...
		<div class="main__content">
			<div class="search-box">
				...
				<br>
	<h1 style="color:red ;font: 35" align="center"> Lịch Sử Bán Hàng</h1>
	
	<table class="table table-bordered" style="font-size: 13px" >
	
	<thead class="table-primary" >
	<tr style="text-align: center;">
	<th style="text-align: center;font-size: 15px ">Mã Nhân Viên</th>
	<th style="text-align: center; font-size: 15px">Mã Sản Phẩm</th>
	<th style="text-align: center;font-size: 15px">Tên Sản Phẩm</th>
	<th style="text-align: center;font-size: 15px">Giá Bán</th>
	<th style="text-align: center;font-size: 15px">Số Lượng Mua</th>
	<th style="text-align: center;font-size: 15px">Ngày Lập</th>
	<th style="text-align: center;font-size: 15px">Thành Tiền</th>
	 
	</tr>
	</thead>
		<%
		ArrayList<LSBHbean> ds = (ArrayList<LSBHbean>) request.getAttribute("ds");
		for(LSBHbean lsbh: ds){
		%>
		<tr >
			<td class="text-center"><%=lsbh.getManv()%></td>
			<td class="text-center"><%=lsbh.getMasp()%></td>
			<td width="20%"><%=lsbh.getTensp()%></td>
			<td class="text-center"><%=lsbh.getGiaBan()%></td>
			<td class="text-center"><%=lsbh.getSoLuong()%></td>
			<td class="text-center"><%=lsbh.getNgayLap()%></td>
			<td class="text-center"><%=lsbh.getThanhTien()%></td>
		</tr>
		<%} %>
	</table>
</body>
