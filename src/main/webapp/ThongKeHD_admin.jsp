	...
	<div class="wrapper">
      ...
      " class="logo"> <!-- logo for regular state and mobile devices -->
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					<li class="treeview active"><a href="#"> <i
						...
						<ul class="treeview-menu">
							<li><a class="sub-nav" href="thongKeDoanhThuController_admin">Doanh
									thu</a></li>
							<li><a class="sub-nav sub-active" href="thongKeHoaDonController_admin">Hóa đơn</a></li>
						</ul></li>
				</ul>
			</section>
		...
		<div class="content-wrapper">
			...
			<div class="header__manage">Thống kê hóa đơn</div>
