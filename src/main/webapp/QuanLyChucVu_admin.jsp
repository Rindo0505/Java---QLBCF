	...
	<div class="wrapper">
      ...
      " class="logo"> <!-- logo for regular state and mobile devices -->
					...
					<li class="treeview active"><a href="#"> <i
						...
						<ul class="treeview-menu">
							...
							<li><a class="sub-nav" href="quanLyTaiKhoanController_admin?tdnadmin=<%=tendn%>">
									Tài khoản </a></li>
							<li><a class="sub-nav sub-active" href="quanLyChucVuController_admin">
									Chức vụ</a></li>
							<li><a class="sub-nav "
		...
		<div class="content-wrapper">
			...
			<div class="header__manage">Quản lý chức vụ</div>
			...
			<div class="main__content">
				...
				<div class="content">
					<div class="content__input">
						<form id="productForm" action="quanLyChucVuController_admin"
							method="POST">
							<div class="payment__detail">
								<label>Mã chức vụ: </label> <input name="macv"
									class="payment__input" type="text"
									value="<%out.print(request.getParameter("macv") != null ? request.getParameter("macv") : "");%>"
									autocomplete="off" required/>
							</div>
							<div class="payment__detail">
								<label>Tên chức vụ: </label> <input name="tencv"
									class="payment__input" type="text"
									value="<%out.print(request.getParameter("tencv") != null ? request.getParameter("tencv") : "");%>"
									autocomplete="off" required />
							</div>
					...
					<%
					ArrayList<ChucVu> dscv = (ArrayList<ChucVu>) request.getAttribute("dscv");
					%>
		...
		<script>
			function confirmDelete() {
				var confirmed = confirm("Bạn có chắc chắn muốn xóa chức vụ?");
			...
			function confirmDelete2(matk) {
				...
				var confirmDeleteInput = document
						.querySelector('input[name="confirm_delete"]');
				var macvInput = document.querySelector('input[name="macv"]');
				if (confirmed) {
					confirmDeleteInput.value = "true";
					macvInput.value = matk;
				} else {
					confirmDeleteInput.value = "false";
				}
				return confirmed;
