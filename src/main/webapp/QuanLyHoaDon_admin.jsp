	...
	<div class="wrapper">
      ...
      " class="logo"> <!-- logo for regular state and mobile devices -->
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview active"><a href="#"> <i
						...
						<ul class="treeview-menu">
							...
							<li><a class="sub-nav sub-active" href="quanLyHoaDonController_admin">
									Hóa đơn</a></li>
		...
		<div class="content-wrapper">
			...
			<div class="header__manage">Quản lý hóa đơn</div>
			...
			<div class="main__content">
				...
				<div class="content">
					<div class="content__input">
						<form id="productForm" action="quanLyHoaDonController_admin"
							method="POST">
							...
							<div class="payment__detail">
								<label>Ngày lập: </label> <input name="nl"
								...
								<td class="text-center col-size">
									<div class="btn__wrapper2">
										<%-- <a class="nav-link btn__link"
											href="quanLyHoaDonController_admin?mahd=<%=hd.getMaHoaDon()%>&nl=<%=hd.getNgayLap()%>&manv=<%=hd.getMaNhanVien()%>">
											<button class="btn btn--edit btn-new">
												<i class="btn__icon fa-solid fa-pen-to-square"></i> Sửa
											</button> --%>
										</a> <a class="nav-link btn__link" href="quanLyCTHDController_admin?mahd=<%=hd.getMaHoaDon()%>&nl=<%=hd.getNgayLap()%>&manv=<%=hd.getMaNhanVien()%>">
