...
<body class="hold-transition skin-blue sidebar-mini">
			...
			<div class="main__content">
				...
				<div class="content">
					<div class="content__input">
						<form id="productForm" action="UpLoadFileController"
							...
							<div class="payment__detail">
								<label>Ảnh sản phẩm: </label> <input name="anhsp"
									class="payment__input" type="file"
							...
							<input type="text"
								value="<%out.print(request.getParameter("anhsp") != null ? request.getParameter("anhsp") : "");%>"
								name="txtAnh" style="size: 40px" hidden>
					...
					<button type="submit" class="btn btn--detail" name="action"
						value="Update">
						<br> <i class="btn__icon fa-solid fa-plus"></i>Update
 ...
 -->
				...
				<a href="quanLySanPhamController_admin">
					<button type="submit" class="btn btn--detail" name="action"
						value="add" style="margin-left: 53px">
						Trở về
 ...
 -->
				...
				<div class="order__detail">
					<table class="order__table" style="margin-left: 50px">
						<tr>
							<th>STT</th>
							<th>Mã sản phẩm</th>
							<th>Tên sản phẩm</th>
							...
							<td class="text-center col-size">
								<div class="btn__wrapper2">
									<a class="nav-link btn__link"
										href="UpLoadFileController?masp=<%=sp.getMaSanPham()%>&tensp=<%=sp.getTenSanPham()%>&anhsp=<%=sp.getAnhSanPham()%>&giaban=<%=sp.getGiaBan()%>&maloaisp=<%=sp.getMaLoaiSP()%>">
